...
#   en_GB_text.py: IDJC language localisation file for en_GB
...
agc_boost = "Boost/Gain (dB)"

agc_right = "Right"

agc_active_tip = "Use processed audio from this microphone channel. When selected unprocessed audio will still be used for the DJ headphones in the DJ audio mix. Activating this feature enables an audio processing pipeline whose features are explained in other tooltips below."

agc_hpcutoff_tip = "Frequency in Hertz above which audio can pass to later stages. Use this feature to restrict low frequency sounds such as mains hum. Setting too high a level will make your voice sound thin."

agc_hfdetail_tip = "You can use this to boost the amount of treble in the audio."

agc_lfdetail_tip = "You can use this to boost the amount of bass in the audio."

agc_compressor_tip = "A lookahead brick wall limiter. Use the Ratio control to boost the quieter sounds. The Limit control is used to set the absolute maximum audio level."

agc_noisegate_tip = "Reduce the unwanted quietest sounds and background noise which you don't want your listeners to hear with this."

agc_deesser_tip = "Reduce the S, T, and P sounds which microphones tend to exagerate. Ideally the Bias control will be set so that the de-esser is off when there is silence but is set high enough that mouse clicks are detected and suppressed."

agc_ducker_tip = "The ducker automatically reduces the level of player audio when the DJ speaks. These settings allow you to adjust the timings of that audio reduction."
...
announcement_initial = "Create a new announcement"

announcement_delete = "Modify or Delete this announcement"

announcement_use = "Announcement"

announcement_next_track = "Next track:"

announcement_lmic = "Left Mic"

announcement_rmic = "Right Mic"

announcement_element = "Announcement"

announcement_control_menu = "Announcement"
...
autoopen = "Automatic Open"

autoopen_tip = "This mic is to be opened automatically when a Player Stop or Announcement playlist control is encountered in the active player. This mic is also to be opened by the advance button."
...
bonus_killer = "End tracks early: those containing excessive silence"
...
enable_track_announcer_tip = "This widget enables the track announcer which is a facility for announcing new tracks on IRC (internet relay chat) using the XChat IRC client. For full instructions on how to use this feature refer to the IDJC documentation in the doc folder or to the IDJC homepage."
...
epc_title = "External Playlist"

epc_active = "  Active  "

epc_choosefile = "Choose a playlist file"

epc_choosedirectory = "Choose a media directory"

exchange = "Exchange"

external = "External"

external_playlist = "Choose a playlist file."
...
in_dj_mix = "In The DJ's Mix"

in_dj_mix_tip = "Make the microphone audio audible in the DJ mix. This may not always be desirable."
...
invert_mic = "Invert Signal"

invert_mic_tip = "Useful for when microphones are cancelling one another out, producing a hollow sound."
...
licence = "Released under the GNU General Public License V2.0"
...
metadata_source_left_deck = "Left Player"

metadata_source_none = "None"

metadata_source_right_deck = "Right Player"
...
mic_meter_tip = "A peak hold meter indicating the microphone signal strength and a meter indicating attenuation levels in the microphone signal processing system. Green indicates attenuation from the noise gate, yellow from the de-esser, red from the limiter."
...
microphone_tab = "Microphones"

middle = "Middle"

mild = "Mild"

mirc_colour_menu = "mIRC Colour Chart"
...
open_mic = "Open/Unmute"

open_unmute_tip = "This controls the allocation of front panel open/unmute buttons. Having one button control multiple microphones can save time." 
...
rdc_title = "Connection Management"

rdc_delaysof = "Delays of"

rdc_seconds = "seconds"

rdc_visible = "Show reconnection dialog on screen"

rdc_autoreconnecthas = "Auto reconnect has..."

rdc_unlimited = "Unlimited retries of 5s delay"

rdc_whenstreambufferfull = "When the stream buffer is full..."

rdc_discard_data = "Discard data"
...
show_stream_meters = "Stream Audio Levels And Connections"
...
those_active = "Only Those Active"
...
unp_gain_tip = "This controls the level of unprocessed audio and when processed audio is selected, the level of microphone audio for the DJ mix."
