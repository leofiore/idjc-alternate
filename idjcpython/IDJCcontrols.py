...
class ControlsUI(gtk.VBox):
    ...
    def __init__(self, owner):
        ...
        for ct in Binding.SOURCES:
            self.source_icons[ct]= gtk.gdk.pixbuf_new_from_file(pkgdatadir+'control_'+ct+gfext)
    ...
    def on_tree_key(self, tree, event, *_):
