...
#   de_DE_text.py: IDJC language localisation file for de_DE
#   Copyright (C) 2008 Fred Flintstone (someblockhead@somewhere.com)
#   Copyright (C) 2008 Barney Rubble (bigdufus@bedrock.net)
#
...
append_cursor = "Unter markiertem einfügen"

attenuation = "Attenuation"

auto = "Automatisch"

autoshutdown = ('Automatisch vom Server getrennt.', 'Grund: shutdown timer.')

basic_streamer = "Kompakt"
...
comp_relative = "Relativ"

connected_to_history = "verbunden mit"

connection = " Verbindung "

control_menu = "Steuerelement einfügen"

copy = "Kopieren"

count_down = "Absteigend"

count_up = "Aufsteigend"

crossfade_control_ltr_element = ">>> Zum rechten Player faden >>>"

crossfade_control_menu = "Fade zum anderem Player"

crossfade_control_rtl_element = "<<< Zum linken Player überblenden <<<"

cue_up = "Aufreihen"

description = "Beschreibung:"

discon_warn = ('Sie werden in einer Minute', 'automatisch vom Server getrennt.')

disconnected = "IDJC nicht verbunden"

disconnected_history = "vom Server getrennt"

disconnection = "IDJC trennt die Verbindung"

dj_name = "DJ-Name:"

dnr_compressor = "Dynamic Range Kompressor"

drc_depth_tip = "This provides what is known as soft knee compression so that the compression ratio ramps up gradually with an increasing audio level rather than suddenly being applied at the 'Knee' point. This makes for a more natural sound and is recommended for compressing the human voice. A sensible value would be 27. Use 0 if you want to use hard knee compression instead . It is recommended to set this value before calibrating 'Knee' since the two interact with one another."
...
enlarge_time_elapsed_tip = "The time elapsed/remaining windows sometimes don't appear big enough for the text that appears in them due to unusual DPI settings or the use of a different rendering engine. This option exists to fix that."

exchange = "Austauschen"

feature_set = "Erscheinung"

finish = "Ende"

from_here = "Von hier alle"

fully_featured = "Ausführlich"

general_tab = "Grundeinstellungen"

genre = "Musikrichtung:"

idjc_shutdown = "IDJC Beenden"

initial_player_settings = "Einstellungen nach Programmstart"

irc_message_timer = "IRC Nachrichten Timer"

is_recording = "IDJC nimmt gerade auf."

is_streaming = "IDJC streamt gerade."
...
left_playlist_addition = "Musik zur linken Abspielliste hinzufügen"

left_playlist_save = "Linke Abspielliste speichern"
...
metadata_source_last_played = "Zuletzt gespielt"

metadata_source_left_deck = "Linker Player"

metadata_source_right_deck = "Rechter Player"

metadata_source_tip = "Dieses Feld left fest, welcher Player die Metadaten für den Stream bereitstellen soll."

mic_in_phones = "Hearing your voice in your headphones (somewhat delayed) can be distracting for some, which is why this feature exists."

mic_peak = "Mik Spitze"

mic_peak_toggle = "Mik Spitze"

mic_vu = "Mik VU"

microphone_tab = "Mikrophon"

mild = "Schwach"

mirc_colour_menu = "mIRC Farbenskala"

normdefaults = "Standardeinstellungen"

off = "Aus"

play_all = "Folgend"

playex_jingles_tip = "This button works as the button to the left does except that the sound level of all the other media players is fully reduced."

playlist = "Abspielliste"

playlist_menu = "Abspielliste"

prefs_button = "Einstellungen"

prefs_window = "IDJC Einstellungen"

prepend = "Oben anhängen"

prepend_cursor = "Über markiertem einfügen"

question_quit = "Wirklich beenden?"

random = "Zufällig"

reconnected = "IDJC hat sich neu verbunden"

reconnected_additional = ('Automatisch Wiederverbunden zum Server', 'nachdem das Servermodul abgest\xc3\xbcrzt ist')

record = " Aufnahme "

record_filename = "Dateiname:"
...
restore_session = "Einstellungen merken"

right = "Rechts:"

right_playlist_addition = "Musik zur linken Abspielliste hinzufügen"

right_playlist_save = "Rechte Abspielliste speichern"

save = "Speichern"

send_metadata = "Sende Metadaten"

sequence = "Sequenz:"

server_connect = "Verbindung herstellen"

server_connect_tip = "Connect to or disconnect from the radio server. If the button does not stay in the connection failed for some reason. Also, if the button is greyed out it means you are using unsupported settings. Shoutcast only supports mp3 and mp3 requires that you use one of the sample rates in the drop down box. Ogg only supports certain sample rate, bit rate, and stereo combinations."

server_type = "Typ:"

server_window = "Radioserver"

set = "Einstellen"

sharp = "Stark"

start_full = "Starte ausführlich"

start_mini = "Starte kompakt"

start_recording_history = "Aufnahme in Datei begonnen"

stop_control_element = "Player anhalten"

stop_control_menu = "Player anhalten"

stop_recording_element = "Aufnahme anhalten"

stop_recording_history = "Aufnahme beendet"

stop_recording_menu = "Aufnahme anhalten"

str_peak = "Str. Spitze"

str_vu = "Str. VU"

stream_disconnect_element = "Streaming anhalten"

stream_disconnect_menu = "Streaming anhalten"

stream_peak_toggle = "Stream Spitze"

stream_peak_toggle_tip = "Controls whether to dislplay a peak-hold signal level meter in the main application window indicating the signal strength of the outgoing stream."

tag_comment = "Kommentar:"

tag_genre = "Musikrichtung:"
...
tagger_filename = "Dateiname:"

this = "Nur dieses"

threshold = "Threshold"

timed_out = ('Automatisch vom Server getrennt,', 'weil dieser nicht antwortete (timeout).')

to_here = "Bis hier alle"

track_announcer = "Titel-Ansage"

track_history_clear = "Inhalt entfernen"

tracks_played = "Gespielte Lieder"

transfer = "Übertragen"

transfer_control_ltr_element = ">>> Zum rechten Player springen >>>"

transfer_control_menu = "Sprung zum anderem Player"

transfer_control_rtl_element = "<<< Zum linken Player springen <<<"

translationcopyright = ('Copyright (C) 2008 Fred Flintstone (someblockhead@somewhere.com)', 'Copyright (C) 2008 Barney Rubble (bigdufus@bedrock.net)')

unexpected = "Die Verbindung zum Server ist fehlgeschlagen."
...
#announce_tip = "Enter the message you want to send here. To include the track currently playing use %s. You can also include colours using Ctrl+K (standard X-Chat/mIRC method) or from the context menu (right click)."
...
#ask_profile_tip = "Causes a profile selection dialogue box to appear when IDJC is started which allows you to have an unlimited number of settings for DJing on multiple radio stations."
...
#licence_window_title = "IDJC Licence Text"
...
#mixer_crash = "The mixer module crashed during initialisation."
...
#no_mp3_stream_available_tip = """Due to concerns over software patents or through oversight, the person or organisation who compiled this program neglected to include support for mp3 encoding.
# 
...
#playlist_modes_tip = """This sets the playlist mode which defines player behaviour after a track has finished playing.
#
...
#record_tab_tip = "Each one of these tabs represents a separate stream recorder. The LED indicator colours represent the following: Clear=Stopped Yellow=Paused Red=Recording."
...
#stream_normalizer = "Stream Normaliser"
...
#stream_tab_tip = "Each one of these tabs represents a separate radio streamer. The LED indicator colours represent the following: Clear=No connection Yellow=Awaiting authentication. Green=Connected. Flashing=Packet loss due to a bad connection."
